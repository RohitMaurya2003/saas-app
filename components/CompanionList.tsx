...
// Function to get the background color based on subject
const getSubjectColor = (subject: string): string => {
    // Return the color from subjectsColors or a default color if not found
                    ...
                    <TableBody>
                        {companions?.map(({id,subject,name,topic,duration}) => (
                            <TableRow key={id}>
                                ...
                                <TableCell>
                                    <div className="flext items-center gap-2 w-full justify-end">
